...
const DEFAULT_SKIN: Skin = {
    ...
    sidebar: [
        ...
        { commandId: 'domain.food-tracker.dashboard', group: 'Digital Køleskab' },
        { commandId: 'domain.food-tracker.scan', group: 'Digital Køleskab' },
        { commandId: 'domain.food-tracker.recipes', group: 'Digital Køleskab' },
        { commandId: 'domain.poster-tracker.dashboard', group: 'Valgplakater' },
        { commandId: 'domain.poster-tracker.add', group: 'Valgplakater' },
        { commandId: 'domain.poster-tracker.teams', group: 'Valgplakater' },
        { commandId: 'domain.poster-tracker.pant', group: 'Valgplakater' },
    ],
