...
const RECIPE_BANK: Recipe[] = [
    ...
    {
        id: 'r9',
        title: 'Rugbrødsmadder med æg og sild',
        description: 'Klassisk dansk frokost — rugbrød med hårdkogte æg og krydret sild.',
        prepTime: '15 min',
        servings: 2,
        difficulty: 'Let',
        usesExpiring: true,
        usedIngredients: ['rugbrød', 'æg', 'sild', 'smør'],
        steps: [
            'Kog æggene i 9 minutter, afkøl og pil dem.',
            'Skær rugbrødet i skiver og smør med smør.',
            'Læg sild og skiver af hårdkogt æg på.',
            'Pynt med rødløg, kapers og dild.',
            'Servér med sennep ved siden af.',
        ],
    },
    {
        id: 'r10',
        title: 'Røræg med bacon og rugbrød',
        description: 'En fyldig dansk morgenmad med bløde røræg, sprødt bacon og godt rugbrød.',
        prepTime: '10 min',
        servings: 2,
        difficulty: 'Let',
        usesExpiring: true,
        usedIngredients: ['æg', 'bacon', 'smør', 'rugbrød'],
        steps: [
            'Steg baconet sprødt i en pande.',
            'Pisk æggene med lidt fløde, salt og peber.',
            'Smelt smør i en pande og tilsæt æggemassen.',
            'Rør forsigtigt til æggemassen er cremet og blød.',
            'Servér på skiver af rugbrød med baconet ved siden af.',
        ],
    },
    {
        id: 'r11',
        title: 'Kartoffelsuppe',
        description: 'Cremet og varmende suppe lavet af kartofler, løg og fløde.',
        prepTime: '35 min',
        servings: 4,
        difficulty: 'Let',
        usesExpiring: true,
        usedIngredients: ['kartofler', 'løg', 'fløde', 'smør'],
        steps: [
            'Skræl og skær kartoflerne i tern.',
            'Sauter løg i smør til de er bløde.',
            'Tilsæt kartofler og dæk med bouillon.',
            'Kog i 20 min og blend til en glat suppe.',
            'Rør fløde i og krydr med salt, peber og purløg.',
        ],
    },
    {
        id: 'r12',
        title: 'Rugbrødspizza',
        description: 'Hurtig aftensmad med rugbrød som bund — god måde at bruge rugbrødet på.',
        prepTime: '15 min',
        servings: 2,
        difficulty: 'Let',
        usesExpiring: true,
        usedIngredients: ['rugbrød', 'tomater', 'ost', 'pølser'],
        steps: [
            'Tænd ovnen på 200 °C.',
            'Læg rugbrødsskiver på en bageplade.',
            'Smør med tomatpuré og læg pålæg efter smag.',
            'Drys ost over og bag i ovnen 8-10 min.',
            'Servér straks og pynt med frisk basilikum.',
        ],
    },
];
